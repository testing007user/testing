...
public class CreateCampaignPage {
	...
	* ##########################################################################	*  Campaign page web element  allocation
	...
	@FindBy(css= "input[data-id = 'nameInput']")
	...
	*/
	...
	{
		if(null==DriverUtility.waitFor(ExpectedConditions.elementToBeClickable(createViewBtn), driver,20))
			throw new FrameworkException(CreateCampaignPage.class.getName()+"is not loaded");
	}
